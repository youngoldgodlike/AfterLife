...
namespace KinematicCharacterController.Examples
{
    public class ExampleCharacterCamera : MonoBehaviour
    {
        ...
        [Header("ForSettings")]
        [SerializeField] private SliderSensitivitySettingWidget _sensitivity;
        ...
        private void Start()
        {
            _sensitivity = GameObject.Find("SenseMouse").GetComponent<SliderSensitivitySettingWidget>();
            _sensitivity.Subscribe(SetRotationSpeed);
        }
